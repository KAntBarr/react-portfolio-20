...
import socialMedia from "../../assets/social_media_clone_y.png";
  ...
  return (
    <>
      <div className='container text-center text-md-start'>
        <h1 className='mt-4 mt-md-5 mb-4 bordered-text'>Past Learning Experiences</h1>
        <div className='row align-items-center'>
          ...
          <Project
            ...
            imageAlt={'Social Media Clone'}
            cardText={'Social Media Clone'}
            projectURL={'https://social-media-clone-akmd.onrender.com'}
            githubURL={'https://github.com/ucb-space-y-p3/social-media-clone-y'}
            projectSummaryNum={0}
          />
          <Project
