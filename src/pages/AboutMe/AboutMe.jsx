...
const AboutMe = ({ }) => {
  ...
  return (
    <div className='container text-center'>
      <h1 className='mt-5 mb-3'>I'm Koby <img src={selfie} alt="A Pic of Koby" className="circle" /></h1>
      <p className='mx-5'>
      ...
      <h2 className='mt-2 mb-3'>Past Education</h2>
      <p>
        My past education includes...
      </p>
      <h2 className='mt-2 mb-3'>Future Developments</h2>
      <p>
