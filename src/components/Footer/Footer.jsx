    ...
    <>
      <footer className="d-flex flex-wrap justify-content-center align-items-center py-3 mt-4 border-top">
        <div className="col-md-4 d-flex align-items-center">
          ...
          <span className="mb-1 mb-sm-0 text-body-secondary">© 2024 Koby's Box, Pending...</span>
        </div>

        <span className="mb-3 mb-sm-0 text-body-secondary mx-5 mx-sm-3">Created Using React</span>

        <ul className="nav col-md-4 justify-content-end list-unstyled d-flex mx-5 mx-sm-0">
