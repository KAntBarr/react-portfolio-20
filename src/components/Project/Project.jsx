...
const Project = ({ imageSrc, imageAlt, cardText, projectURL, githubURL }) => {
        ...
        <div className='d-flex justify-content-center'>
          <div className="card" style={{ width: '18rem' }}>
            ...
            <div className="card-body d-flex justify-content-between">
              ...
              <button className="btn btn-primary " data-bs-toggle="modal" data-bs-target="#exampleModal" style={{ lineHeight: 0 }}>...</button>
            </div>
          </div>
        </div>
      </div>
